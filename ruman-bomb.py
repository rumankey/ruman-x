...
##########################################################
# DEV : ITZ RUMAN YT
# Github : https://github.com/rumankey
...
{acl}[ {ycl}4. {acl}] {gcl}THZ (FB PAGE)
{acl}[ {ycl}5. {acl}] {gcl}THZ(FB GROUP)
...
try:
  while True:
    ...
    elif mao =="4":https://www.facebook.com/ruman.banglades1/
      os.system('xdg-open ')
      break
    elif mao=="5":
      os.system('xdg-open ')https://www.facebook.com/groups/905369883487008/
      break
    elif mao=="0":
